    ...
    public static OptionPage general() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> {
                            opts.getEnableVsync().setValue(value);
                        }, opts -> opts.getEnableVsync().getValue())
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.getBobView().setValue(value), opts -> opts.getBobView().getValue())
                        .build())
    ...
    public static OptionPage quality() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setBinding((opts, value) -> opts.getEntityDistanceScaling().setValue(value / 100.0), opts -> (int) (Math.round(opts.getEntityDistanceScaling().getValue()) * 100))
                        .setImpact(OptionImpact.MEDIUM)
                        .build()
                )
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
